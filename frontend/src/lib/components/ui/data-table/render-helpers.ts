 ...
 * ```
 */
export class RenderComponentConfig<Props extends Record<string, unknown>> {
	component: Component<Props>;
	props: Props;
	constructor(component: Component<Props>, props: Props = {} as Props) {
